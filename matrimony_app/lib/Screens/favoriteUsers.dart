        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              ? searchedUser.where((element) => element.isFavorite==true,).length 
              : userProvider.userList.where((element) => element.isFavorite==true,).length,
              itemBuilder: (context, index) {
                UserModel _user = search.text.isNotEmpty 
                ? searchedUser.where((element) => element.isFavorite==true,).toList()[index] 
                : userProvider.userList.where((element) => element.isFavorite==true,).toList()[index];
                  return Padding(
  ...
  UserProvider userProvider = Provider.of<UserProvider>(context);
    return Slideable(
      ...
      items: <ActionItems>[
        ActionItems(
          icon: Icon(
            user.isFavorite ? Icons.thumb_up : Icons.thumb_down_outlined,
            color: Colors.blue,
          ),
          onPress: (){
            setState(() {
